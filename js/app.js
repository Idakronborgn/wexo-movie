...
async function getMovies() {
    let response = await fetch("https://feed.entertainment.tv.theplatform.eu/f/jGxigC/bb-all-pas/106608168011?form=json");
...
// =========== min egen kode der virkede i en anden mappe =========== //
...
//   ('searchInput');
//   fetch(GET = 'https://feed.entertainment.tv.theplatform.eu/f/jGxigC/bb-all-pas?form=json&range=1-20&byTags=genre:action&byYear=2017&byProgramType=movie')
...
//           html +=`
//           <div class="movie-item" data-id="${movie.id}" data-id="${movie.plprogram$thumbnails}">
//           <div class="movie-name">
//             <h3>${movie.title}</h3>
//             <div class="movie-img">
//             <img src="${movie.plprogram$url}"> //virker ikke med img
//             </div>
//             <p>${movie.description}</p>
//             <a href="#" class="recipe-btn">Se mere!</a>
//           </div>
//         </div>
//           `;
//         });
